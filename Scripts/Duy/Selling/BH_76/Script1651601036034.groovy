...
WebUI.setText(findTestObject('Object Repository/selling/Page_Bn hng/input_Chn_amount'), '10')
...
WebUI.verifyMatch(alertText, 'Chưa chọn sản phẩm;', false)

//WebUI.verifyTextPresent('Chưa chọn sản phẩm;', false)
