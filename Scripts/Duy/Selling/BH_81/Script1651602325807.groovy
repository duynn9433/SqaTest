...
WebUI.click(findTestObject('Object Repository/selling/Page_ng nhp/input_Ti khon_username'))
...
WebUI.sendKeys(findTestObject('Object Repository/selling/Page_Bn hng/input_Tm_goodsname'), Keys.chord(Keys.ENTER))
