...
WebUI.click(findTestObject('Object Repository/selling/Page_Bn hng/label_b'))

WebUI.verifyElementPresent(findTestObject('selling/Page_Bn hng/label_b'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/selling/Page_Bn hng/label_2222222222'), 0)
