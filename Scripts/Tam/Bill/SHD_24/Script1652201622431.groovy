...
WebUI.setText(findTestObject('Object Repository/Page_Trang Ch Sn Phm/input_Gim gi_saleOff'), '')

WebUI.click(findTestObject('Object Repository/Page_Trang Ch Sn Phm/input_Ch thch_btn btn-primary'))

WebUI.click(findTestObject('Object Repository/Page_Trang Ch Sn Phm/input_Gim gi_saleOff'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Trang Ch Sn Phm/h1_Sa thng tin n hng'), 0)
