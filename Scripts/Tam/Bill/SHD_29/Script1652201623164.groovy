...
WebUI.click(findTestObject('Object Repository/Page_Seller Home/input_GGG_edit'))

WebUI.click(findTestObject('Object Repository/Page_Trang Ch Sn Phm/td'))

WebUI.setText(findTestObject('Object Repository/Page_Trang Ch Sn Phm/input_lon_amount'), '')

WebUI.click(findTestObject('Object Repository/Page_Trang Ch Sn Phm/input'))
