...
WebUI.setText(findTestObject('client/Page_Manager Home/input_a ch_address'), 'Hoa binh')

WebUI.setText(findTestObject('client/Page_Manager Home/input_ST_phoneNumber'), 'aaaaaa')
