...
WebUI.setText(findTestObject('client/Page_Thm khch hng/input_Tn_name'), '')

WebUI.setText(findTestObject('client/Page_Thm khch hng/input_S in thoi_phoneNumber'), '')

WebUI.setText(findTestObject('client/Page_Thm khch hng/input_a ch_address'), '')

WebUI.click(findTestObject('client/Page_Thm khch hng/input_a ch_button'))

WebUI.verifyElementNotClickable(findTestObject('client/Page_Thm thnh cng/input'))
