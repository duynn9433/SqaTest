...
WebUI.setText(findTestObject('client/Page_Thm khch hng/input_Tn_name'), 'a')

WebUI.setText(findTestObject('client/Page_Thm khch hng/input_S in thoi_phoneNumber'), '012136980')
