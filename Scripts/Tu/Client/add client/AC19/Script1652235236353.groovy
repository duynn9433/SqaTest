...
WebUI.setText(findTestObject('client/Page_Thm khch hng/input_S in thoi_phoneNumber'), '0123456321')

WebUI.setText(findTestObject('client/Page_Thm khch hng/input_a ch_address'), 'Hoa binh')
