...
WebUI.setText(findTestObject('client/Page_Thm khch hng/input_Tn_name'), 'Nguyen Van A')

WebUI.setText(findTestObject('client/Page_Thm khch hng/input_S in thoi_phoneNumber'), 'aaaaaa')
